...
import { P as PageRouteSymbol, d as useRoute, e as appLayoutTransition, _ as _wrapIf, L as LayoutMetaSymbol, f as useNuxtApp } from './server.mjs';
import { useRoute as useRoute$1 } from 'vue-router';

const layouts = {
  weblayout: () => import('./weblayout-B4cdpe2C.mjs').then((m) => m.default || m)
};
...
//# sourceMappingURL=nuxt-layout-BdMgwAjR.mjs.map
